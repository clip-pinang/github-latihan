...
| ----------- | ---------------------------------------- | ---- | ----- |
| Awal | [![Tampilan Home](/document/aplikasi/potret/images/integrasi/01-epormas-web-tampilan-awal.png)](/document/aplikasi/potret/images/01-epormas-web-tampilan-awal.png) | | |
...
#### 3.2 Tampilan Setelah Install Aplikasi dan Registrasi
| Tampilan | URL/ Image | Ada | Tidak |
| -------------------- | ---------------------------------------- | ---- | ----- |
...
| Create New Permission | [![Create New Permission](/document/aplikasi/potret/images/ntegrasi/14-epormas-web-form-permission.png)](/document/aplikasi/potret/images/ntegrasi/14-epormas-web-form-permission.png) | | |
...
#### 4.7 Konten Menu Workflows
| Tampilan | URL/ Image | Ada | Tidak |
| -------------- | ---------------------------------------- | ---- | ----- |
| Workflows List | [![Workflows List](/document/aplikasi/potret/images/ntegrasi/17-epormas-web-workflow-list.png)](/document/aplikasi/potret/images/ntegrasi/17-epormas-web-workflow-list.png) | | |
...
#### 4.9 Konten Menu Transition List
| Tampilan | URL/ Image | Ada | Tidak |
| --------------- | ---------------------------------------- | ---- | ----- |
...
#### 4.11 Konten Menu Attachment List
| Tampilan | URL/ Image | Ada | Tidak |
| --------------- | ---------------------------------------- | ---- | ----- |
...
| Add New Guard | [![Add New Guard](/document/aplikasi/potret/images/integrasi/26-epormas-web-form-attachment.png)](/document/aplikasi/potret/images/integrasi/26-epormas-web-form-attachment.png) | | |
